...
export class MedicoService {
  ...
  findMedicosDisponiveis(params: MedicoBuscaDisponibilidadeParams): Observable<MedicoDisponivelDTO[]> {
    ...
    return this.http.get<MedicoDisponivelDTO[]>(`${this.apiUrl}/disponibilidade`, { params: httpParams });
  }

  /**
   * Busca os períodos de disponibilidade salvos pelo próprio médico.
   * Consumirá o endpoint: GET /api/v1/medicos/disponibilidade
   */
  getMinhaDisponibilidade(): Observable<PeriodoDisponibilidadeMedico[]> {
    return this.http.get<PeriodoDisponibilidadeMedico[]>(`${this.apiUrl}/disponibilidade`);
  }

  /**
   * Salva os novos períodos de disponibilidade do médico.
   * Consumirá o endpoint: POST /api/v1/medicos/disponibilidade
   */
  salvarMinhaDisponibilidade(periodos: PeriodoDisponibilidadeMedico[]): Observable<void> {
    ...
    const urlCompleta = `${this.apiUrl}/disponibilidade`; // Sem '/me'
